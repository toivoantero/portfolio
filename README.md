...
This version is built with HTML and CSS and showcases my programming projects and graphic design.

## 🌐 Live Demo (Old Version)

The old portfolio is still hosted here:  
[markusliimatainen.onrender.com](https://markusliimatainen.onrender.com)

> **Note:** This is the legacy portfolio. The current 2025 version is hosted on Webflow:  
> [markusliimatainen.webflow.io](https://markusliimatainen.webflow.io)
